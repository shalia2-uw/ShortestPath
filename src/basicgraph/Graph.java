...
public abstract class Graph {
	...
	public List<Integer> degreeSequence() {
		...
		for(int i=0;i<numVertices;i++){
			int numDegree = getNeighbors(i).size()+getInNeighbors(i).size();
			degree.add(numDegree);
		}
	...
	public static void main (String[] args) {
		...
		/*System.out.println(airportGraph.getDistance2(3));
		GraphAdjMatrix m = new GraphAdjMatrix();
		GraphLoader.loadRoutes("data/airports/routesUA.dat", m);
		System.out.println("Matrix: "+m.getDistance2(3));*/
	}
}
